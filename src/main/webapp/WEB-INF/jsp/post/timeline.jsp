...
<h2 class="my-3 text-center text-white" id="howAbout">How about this?</h2>
			...
			<div class="timeline-box">
				...
				<div class="card border rounded mt-3">
					...
					<div class="p-2 d-flex justify-content-between">
						<span class="font-weight-bold"><a href="/user/in/timeline_view?userId=${cardView.user.id }" class="individualBtn text-dark">${cardView.user.nickName }</a></span>
